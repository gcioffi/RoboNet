...
if __name__=='__main__':
    ...
    save_data(out_dir, train_list, train_images, 'train', False)
    save_data(out_dir, train_list, train_images_grayscale, 'train', True)
    
    save_data(out_dir, valid_list, valid_images, 'valid', False)
    save_data(out_dir, valid_list, valid_images_grayscale, 'valid', True)

    save_data(out_dir, test_list, test_images, 'test', False)
    save_data(out_dir, test_list, test_images_grayscale, 'test', True)
